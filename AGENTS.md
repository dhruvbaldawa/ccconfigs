<!-- packport-managed-instructions:personal:codex:claude-instructions:project:start -->
<!-- packport-profile: personal -->
<!-- packport-target: codex -->
<!-- packport-scope: project -->

<!-- packport-source: claude-instructions/instruction/project-claude -->
# CLAUDE.md
...
<!-- packport-managed-instructions:personal:codex:claude-instructions:project:end -->

<!-- packport-managed-instructions:personal:codex:claude-instructions:user:start -->
<!-- packport-profile: personal -->
<!-- packport-target: codex -->
<!-- packport-scope: user -->

<!-- packport-source: claude-instructions/instruction/user-claude -->
...
@RTK.md
<!-- packport-managed-instructions:personal:codex:claude-instructions:user:end -->
